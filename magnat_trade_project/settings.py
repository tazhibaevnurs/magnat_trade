...
# Email verification / reset delivery (SMTP, например Mail.ru: smtp.mail.ru:465 + SSL)
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "no-reply@magnat-trade.local")
...
# Массовая загрузка галереи каталога в админке (products.Product): несколько POST подряд + больший лимит тела.
PRODUCT_GALLERY_UPLOAD_FILES_PER_BATCH = int(os.getenv("PRODUCT_GALLERY_UPLOAD_FILES_PER_BATCH", "8"))
PRODUCT_GALLERY_UPLOAD_MAX_FILES_PER_REQUEST = int(os.getenv("PRODUCT_GALLERY_UPLOAD_MAX_FILES_PER_REQUEST", "24"))
PRODUCT_GALLERY_UPLOAD_MAX_FILE_BYTES = int(
    os.getenv("PRODUCT_GALLERY_UPLOAD_MAX_FILE_BYTES", str(8 * 1024 * 1024)),
)
ADMIN_GALLERY_BATCH_UPLOAD_MAX_BYTES = int(
    os.getenv("ADMIN_GALLERY_BATCH_UPLOAD_MAX_BYTES", str(52 * 1024 * 1024)),
)
