...
urlpatterns = [
    path("media/<path:file_path>/", views.public_media_proxy, name="public_media_proxy"),
    ...
    path('password-reset/', views.password_reset_request_page, name='password-reset-request'),
    path('password-reset/confirm/', views.password_reset_confirm_page, name='password-reset-confirm'),
    path('shop/', views.shop, name='shop'),
    path('novinki/', views.shop_new_arrivals, name='shop_new_arrivals'),
    path('akcii/', views.shop_promotions, name='shop_promotions'),
    path('shop/grid/', views.shop_grid, name='shop_grid'),
    path('novinki/grid/', views.shop_new_arrivals_grid, name='shop_grid_new_arrivals'),
    path('akcii/grid/', views.shop_promotions_grid, name='shop_grid_promotions'),
    ...
    path('api/shop/search-suggest/', views.search_suggest_api, name='search-suggest-api'),
    path('cart/', views.cart, name='cart'),
    path('about-us/', views.about_us, name='about-us'),
    path('contact-us/', views.contact_us, name='contact-us'),
    path('profile/', views.user_profile, name='profile'),
    path('profile/orders/', views.profile_orders, name='profile_orders'),
    path("wishlist/login-required/", views.wishlist_login_redirect, name="wishlist_login_redirect"),
    path("wishlist/toggle/", views.wishlist_toggle, name="wishlist_toggle"),
    path("wishlist/", views.wishlist, name="wishlist"),
    path("profile/wishlist/", views.wishlist),
    ...
    path("orders/<uuid:order_id>/pdf/", views.order_pdf, name="order_pdf"),
    path("orders/<uuid:order_id>/print/", views.order_print, name="order_print"),
]
